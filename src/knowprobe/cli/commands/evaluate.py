...
def evaluate_single(
    ...
    reference: Annotated[str | None, typer.Option("--reference", "-r", help="Reference answer or ground truth")] = None,
    metrics: Annotated[
        list[str],
        typer.Option("--metric", help="Evaluation metrics to use (can specify multiple)", case_sensitive=False),
    ] = ["bleu"],
...
def evaluate_batch(
    ...
    references_file: Annotated[Path | None, typer.Option("--references", "-r", help="Path to references JSON/JSONL file")] = None,
    metrics: Annotated[
        list[str],
        typer.Option("--metric", help="Evaluation metrics to use (can specify multiple)", case_sensitive=False),
    ] = ["bleu", "rouge"],
    output: Annotated[Path, typer.Option("--output", "-o", help="Output file path (JSON)")] = Path("evaluation_results.json"),
    config: Annotated[Path | None, typer.Option("--config", "-c", help="Config file path")] = None,
    verbose: Annotated[bool, typer.Option("--verbose", "-v", help="Enable verbose output")] = False,
) -> None:
...
def compare_strategies(
    results_dir: Annotated[Path, typer.Argument(help="Directory containing evaluation result files")],
    output: Annotated[Path | None, typer.Option("--output", "-o", help="Output comparison report path")] = None,
    config: Annotated[Path | None, typer.Option("--config", "-c", help="Config file path")] = None,
    verbose: Annotated[bool, typer.Option("--verbose", "-v", help="Enable verbose output")] = False,
) -> None:
