...
from .utils import CLIError, console, print_error, print_info, print_success, print_warning
...
def main_callback(
    ...
    config: Annotated[
        Path | None, typer.Option("--config", "-c", help="Global config file path")
    ] = None,
    verbose: Annotated[
        bool, typer.Option("--verbose", "-v", help="Enable verbose output globally")
    ] = False,
    quiet: Annotated[
